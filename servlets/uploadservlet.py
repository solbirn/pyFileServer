...
class UploadApp(object):
    ...
    def index(self, batch=None):
        ...
        <script src="/cache/js/vendor/jquery.ui.widget.js"></script>
        <!-- The Templates plugin is included to render the upload/download listings -->
        <script src="/cache/js/tmpl.min.js"></script>
        <!-- The Load Image plugin is included for the preview images and image resizing functionality -->
        <script src="/cache/js/load-image.min.js"></script>
        <!-- The Canvas to Blob plugin is included for image resizing functionality -->
        <script src="/cache/js/canvas-to-blob.min.js"></script>
        <!-- Bootstrap JS and Bootstrap Image Gallery are not required, but included for the demo -->
        <script src="/cache/js/bootstrap.min.js"></script>
        <script src="/cache/js/bootstrap-image-gallery.min.js"></script>
        <!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
        <script src="/cache/js/jquery.iframe-transport.js"></script>
        <!-- The basic File Upload plugin -->
        <script src="/cache/js/jquery.fileupload.js"></script>
        <!-- The File Upload image processing plugin -->
        <script src="/cache/js/jquery.fileupload-ip.js"></script>
        <!-- The File Upload user interface plugin -->
        <script src="/cache/js/jquery.fileupload-ui.js"></script>
        <!-- The localization script -->
        <script src="/cache/js/locale.js"></script>
        <!-- The main application script -->
        <script src="/cache/js/main.js"></script>
        <!-- The XDomainRequest Transport is included for cross-domain file deletion for IE8+ -->
        <!--[if gte IE 8]><script src="/cache/js/cors/jquery.xdr-transport.js"></script><![endif]-->
        """, login=True)
    index.exposed = True
